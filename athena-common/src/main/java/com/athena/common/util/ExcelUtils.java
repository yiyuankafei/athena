...
//List<StoreTempExcelDTO> storeTempDTOList = ExcelUtils.readExcel("", StoreTempExcelDTO.class, file,0);
...
public class ExcelUtils {
    ...
    public static <T> List<T> readExcel(String path, Class<T> cls, MultipartFile file, int sheetNum) {
